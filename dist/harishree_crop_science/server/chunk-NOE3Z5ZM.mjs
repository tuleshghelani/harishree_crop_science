...
// src/app/shared/services/svg-icons.service.ts
var SvgIconsService = class _SvgIconsService {
  constructor() {
    this.researchIcons = {
  ...
  static {
    this.\u0275fac = function SvgIconsService_Factory(t) {
      return new (t || _SvgIconsService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _SvgIconsService, factory: _SvgIconsService.\u0275fac, providedIn: "root" });
  }
};
...
//# sourceMappingURL=chunk-NOE3Z5ZM.mjs.map
