...
var ProductService = class _ProductService {
    ...
    this.categories = [
      {
        ...
        products: [
          ...
          },
          {
            ...
            description: "Effective pest management",
          ...
          },
          {
            ...
            description: "Premium insect protection",
  ...
  searchProducts(query) {
    ...
    const matchingProducts = this.categories.reduce((acc, category) => {
      const matches = category.products.filter((product) => product.name.toLowerCase().includes(searchTerm) || product.description.toLowerCase().includes(searchTerm));
      return [...acc, ...matches];
    }, []);
...
//# sourceMappingURL=chunk-D5MUVTGS.mjs.map
