...
var routes = [
  { path: "", loadComponent: () => import("./chunk-4UXPXS2Y.js").then((m) => m.HomeComponent) },
  { path: "about-us", loadComponent: () => import("./chunk-RBF7BQII.js").then((m) => m.AboutComponent) },
  { path: "contact-us", loadComponent: () => import("./chunk-B4MTKTFW.js").then((m) => m.ContactUsComponent) },
  { path: "products", loadComponent: () => import("./chunk-5J2KZCDI.js").then((m) => m.ProductsComponent) },
  { path: "products/:productName", loadComponent: () => import("./chunk-5J2KZCDI.js").then((m) => m.ProductsComponent) },
  { path: "catalogue", loadComponent: () => import("./chunk-HLNSHDNO.js").then((m) => m.CatalogueComponent) },
  { path: "research", loadComponent: () => import("./chunk-RPXGNSWY.js").then((m) => m.ResearchComponent) },
  { path: "quality-assurance", loadComponent: () => import("./chunk-KEWX7LGV.js").then((m) => m.QualityAssuranceComponent) },
  { path: "product/proceed", loadComponent: () => import("./chunk-OLB5NLEN.js").then((m) => m.ProceedComponent) },
  { path: "product/thio-h", loadComponent: () => import("./chunk-2KE4NM7I.js").then((m) => m.ThioHComponent) },
  { path: "product/super-fs", loadComponent: () => import("./chunk-FRMGPCTH.js").then((m) => m.SuperFsComponent) },
  { path: "product/mpire-404", loadComponent: () => import("./chunk-F3HTXG3W.js").then((m) => m.Mpire404Component) },
  { path: "product/h-fun", loadComponent: () => import("./chunk-PUVWVQ5D.js").then((m) => m.HFunComponent) },
  { path: "product/glyphosate-41-sl", loadComponent: () => import("./chunk-NPNJR7YF.js").then((m) => m.Glyphosate41SlComponent) },
